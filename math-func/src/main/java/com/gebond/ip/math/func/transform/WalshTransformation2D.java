 ...
 */
public class WalshTransformation2D extends OperationManager<FourierContext.FourierContext2D> {
  ...
  public List<Operation<FourierContext.FourierContext2D>> getOperations() {
    return Arrays.asList(
        ...
        new WalshSynthesis2D());
  }

  public static class WalshAnalysis2D extends Operation2D {
  ...
  public static class WalshSynthesis2D extends Operation2D {
