...
public class CompressionSetting {
  ...
  /**
   * Compression rate means remaining Example: compressionRate = 0 - nothing to compress
   * compressionRate = 50 - half of input array will be zero compressionRate = 100 - whole input
   * array will be zero
   */
