...
/**
 * A class that "blitzes" an object by calling it many times, from multiple threads.  Used for
 * stress-testing synchronisation.
 *
 * @author nat
 */
public class MultithreadedStressTester {
  ...
  public void blitz(long timeoutMs, final Runnable action)
